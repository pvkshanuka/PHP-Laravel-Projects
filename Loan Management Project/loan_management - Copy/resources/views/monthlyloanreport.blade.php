...
<body onload="">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Monthly loan Summary</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="/chequeLoanAdSearch" id="checkcollectamountform" method="POST"
                            ...
                            <div class="row">
                                        ...
                                        <div class="dataTables_length" id="bootstrap-data-table-export_length">
                                            <label>LoanType :
                                                <select id="loantype" name="Ltype"
                                                    ...
                                                    <option value="3">Monthly Loan</option>
                                ...
                                <div class="col-sm-4 col-md-3" id="bootstrap-data-table-export_length">
                                    <label>Rate:
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <label>Print :<br> <button type="submit" id="printPage"
                                            class="btn btn-secondary btn-sm">Print
                                            Report</button></label>
                            ...
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="sorting_1">@if($smry->ltype==3)

                                            <span class="badge badge-light">Monthly Loan</span>

                                            @elseif($smry->ltype==6)

                                            <span class="badge badge-secondary">Cheque Loan</span>
                                            @endif
                                        </td>
   ...
   function sumData(){
            ...
            for(var i = 1; i < table.rows.length; i++)
            {
                ...
                sumVal1 = sumVal1 + parseFloat(table.rows[i].cells[6].innerHTML);
            }
