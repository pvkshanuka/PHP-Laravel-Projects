...
<div class="container">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            <label>Email</label>
            <input type="email" id="ccemailudt" name="email" value="{{$ccdetails->email}}" class="form-control"
                placeholder="nic">
        </div>
    </div>
    <div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            <div class="input-group-btn"><button onclick="updateEmployeeDetails({{$ccdetails->employeeId}})"
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            <div class="input-group-btn"><button onclick="updateEmployeeCredintials({{$ccdetails->idlogin}})"
