                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="card-body card-block">
                                                                   ...
                                                                   <div class="row">
                                                                       ...
                                                                       <div class="col-md-6">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" id="loanId" style="color: red"
                                                                                name="input2-group2"
                                                                ...
                                                                <div class="col col-md-12">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="input-group-btn">
                                                                            <button
                                                                                class="btn btn-primary" id="searchbtn" onclick="serachCustomer(); LoanHistory();">Search</button>
                                                                        </div>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9">
                                                                    <select name="select" id="loantypeid" class="form-control" onchange="filterLtype();">
                                                ...
                                                foreach ($clevel_data as  $rname) {?>
                                                    ...
                                                    <option value="{{$rname->loanTypeId}}">{{$rname->name}}</option>
                                             ...
                                             <?php
                                                        ...
                                                        <div id="monthlyloan1">
                                                                <div class="form-group">
                                                                    <label for="cc-payment" class="control-label mb-1">Total Loan
                                                                        Amount</label>
                                                                    <input id="ptypeamount"  type="text"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <button type="button" class="btn btn-outline-warning btn-sm" onclick="monthlycalculate();">Calculate</button>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="cc-payment" class="control-label mb-1">Change Amount</label>
                                                        ...
                                                        <div id="monthly">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <button id="payment-button" type="submit" onclick="CalculateMonthly();"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="totinterst"  type=""
                                                                    class="form-control" aria-required="true"
                                                                    aria-invalid="false"  disabled style="color: red">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="cc-payment" class="control-label mb-1">
                                                                    Total pay Amount</label>
                                                                <input id="Payamount"  type=""
                                                                    class="form-control" aria-required="true"
                                                                    aria-invalid="false"  disabled style="color: green">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="cc-payment" class="control-label mb-1">
                                                                    Next payment Day</label>
                                                                <input id="nextpaydate"  type=""
                                                                    class="form-control" aria-required="true"
                                                                    aria-invalid="false"  disabled style="color: green">
                                                            </div>
                                                            <label for="cc-payment" class="control-label mb-1">
                                                                <strong> payment Day</strong></label>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        ...
                                                        <div id="property">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <button onclick="calculatepropty()" type="submit" class="btn btn-success btn-sm">Calculate</button>
                                                                </div>
                                                                <div class="col-md-6">
                                                        ...
                                                        <div id="cheque">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="cc-payment" class="control-label mb-1">Cheque
                                                                    Amount</label>
                                                            ...
                                                            <div class="form-group"> 
                                                                <label for="cc-payment" class="control-label mb-1">Interst
                                                                    </label>
                                                                    <div class="input-group">
                                                                        <input type="number" id="Cinterest"
                                                                            name="Cinterest"
                                                                            placeholder="Set Interst"
                                                                            class="form-control">
                                                                        <div class="input-group-btn">

                                                                            <button class="btn btn-primary" type="submit" onclick="chequePayCal();" id="searchbtn" >Calculate</button>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="cc-payment"
                                                                                ...
                                                                                Amount</label>
                                                                        <input id="Ctotamount" name="totale_payble_amount" type="text"
                                                                                class="form-control" aria-required="true"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="cc-payment"
                                                                                ...
                                                                                <input style="color: green" id="Cprofit" name="totale_payble_amount" type="text"
                                                                                class="form-control" aria-required="true"
                                                                                aria-invalid="false" disabled>
                                                                        </div> 
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input id="Cnum4us"  type="text"
                                                                            class="form-control" aria-required="true" placeholder="0000-0000-0000"
                                                                            aria-invalid="false">
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="cc-payment" class="control-label mb-1">
                                                                        ...
                                                                        <input id="Cbank4us"  type="text"
                                                                            class="form-control" aria-required="true" placeholder="bank Name"
                                                                            aria-invalid="false">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="stat-widget-four">
                                                                        ...
                                                                        <div class="stat-content">
                                                                            <div class="text-left dib">
                                                                                <div class="stat-heading"><strong> Payment Last Date</strong></div>
                                                                                <div class="stat-text"><h1 id="dendate"  style="color: red">YYYY-MM-DD</h1></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div id="historyalert" class="alert alert-info" role="alert" style="visibility: hidden">
                                                                No Loan History!
                                                        </div>
                                                ...
                                                <aside class="profile-nav alt">
                                                    <section class="card">
                                                        <div class="card-header user-header alt bg-dark">
                                                            <div class="media">
                                                                <a href="#">
                                                                    <img id="gimg" class="align-self-center rounded-circle mr-3"
                                                                        style="width:85px; height:85px;" alt=""
                                                                        src="images/admin.jpg">
                                                                </a>
                                                                <div class="media-body">
                                                                    <div class="raw">
                                                                    <div class="col col-8">
                                                                        <h2 class="text-light display-6" id="gname">Guarantor</h2>
                                                                        <p id="gnic"></p>
                                                                        <p id="setgid"></p>
                                                                    ...
                                                                    <div class="col col-4">
                                                                        <button class="btn btn-secondary"  id="srchGbtn" onclick="GuarantoraddTabale();">Add</button>
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item">
                                                                <a href="#" id="gmobile"> <i class="fa fa-phone"></i> </a>
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-12">
                                                                <div class="input-group">
                                                        <input type="text" id="guanic"
                                                        name="input2-group2"
                                                        placeholder="Search Guarantor"
                                                        class="form-control">
                                                        <div class="input-group-btn">
                                                            <button
                                                                class="btn btn-primary" id="srchGbtn" onclick="serachGuarantor()">Search</button>
                                                        </div>
                                                    </div>
                                                            </div>
                                                        </div>
...
function filterLtype(){
    ...
    genarateId(name);
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                          ...
                          for(var i=0;lenght>i;i++){
                            ...
                            tabledata = "<tr><td>"+data[i]+"</td><td>"+amo+"</td></tr>";
                            $("#loanPlan").append(tabledata);
                          }
             ...
             function CalculateMonthly(){
                ...
                if (amount!="" && interst !="") {
                    ...
                    document.getElementById('totinterst').value=totale_interst;
             ...
             function p_clculate(){
                ...
                if (amount!="" && count !="" && interst!="") {
                        ...
                        document.getElementById('monthlypayamount').value=n;
             ...
             function calculatepropty(){
                       ...
                       var amo =  finalamo.toFixed(2);
                        document.getElementById('calamount').value=amo;
                        document.getElementById('changeamount').value=amo;
                        }else{
                            const Toast = Swal.mixin({
                                toast: true,
                                position: 'top-end',
             ...
             function monthlycalculate(){
                ...
                var count = document.getElementById('countptype').value;
                    ...
                    if (amount!="" && interst!="" && count!="") {
                       ...
                       var amo =  finalamo.toFixed(2);
                       document.getElementById('monthpayamohidn').value=amo;
                        document.getElementById('monthpayamo').value=amo;
   ...
   if (pay_method==0) {
       ...
       if (Camount!="" && Cinterest!=""&&Cnum4us!=""&& Cbank4us!=""&& Cdate4us!="") {
