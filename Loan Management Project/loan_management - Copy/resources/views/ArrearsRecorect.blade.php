                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <input id="newrate" type="text"
                                                                            class="form-control" placeholder="Interst (%)">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <input id="arrmonth" type="text"
                                                                            class="form-control" placeholder="Arrears Month" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row" id="HIDDN1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php
                                                        $clevel_data = DB::table('bankaccount')->where('status',0)->get();
        ...
        $(document).ready(function () {
               document.getElementById("loanmngsb").setAttribute("class", "menu-item-has-children dropdown active");
                    ...
                    function recalculate(){
                        ...
                        var count = document.getElementById('arrmonth').value;

                        if (arramount!="" && rate!="" && count!="") {

                            if (rate<20) {
                                var amo = arramount/100*rate;
                            var amo2 = amo*count;
                            var amo3 = +amo2 + +arramount;

                        document.getElementById('newamount').value=amo3;
                            }else{
                        ...
                        Toast.fire({
                            type: 'warning',
                            title: 'Addto interst minimum value is 20%...!'
                        });
                            }
                    ...
                    if (data.status==2) {
                        ...
                        for(var i=0;i<lenght;i++){
                          ...
                          const formatter = new Intl.NumberFormat('LKR', {
                           ...
                           contet = "<ul class='list-group list-group-flush'><li class='list-group-item'><a href='#'> <i class='fa  fa-money'></i> Full Loan Amount <span class='badge badge-primary pull-right'>"+formatter.format(totamount)+"</span></a> </li> <li class='list-group-item'><a href='#'> <i class='fa fa-money'></i> Payment Amount <span class='badge badge-success pull-right'>"+formatter.format(payamount)+"</span></a></li><li class='list-group-item'> <a href='#'> <i class='fa fa-money'></i> Due Amount <span class='badge badge-danger pull-right' >"+formatter.format(balance)+"</span></a> </li><li class='list-group-item'> <a href='#'> <i class='fa fa-calendar'></i> Loan End Date <span class='badge badge-warning pull-right' >"+enddate+"</span></a> </li> <li class='list-group-item'><button id='tranfer' onclick='closeloan("+loanId+")' type='submit' class='btn btn-lg btn-info btn-block'> <i class='fa fa-edit fa-lg'></i>&nbsp;<span id='payment-button-amount'>Transfer New Loan</span> </button></li></ul>"
                          $("#loaddetais").append(contet);
                          contet = " <tr><th>"+culonid+"</th> <td>"+enddate+"</td>  <td>"+formatter.format(totamount)+"</td> <td style='color:red'><strong>"+formatter.format(balance)+"</strong></td></tr>";
                          $("#arrdata").append(contet);
                        }
                        },
             ...
             function viewPlan(){
                ...
                var newamount = document.getElementById("newamount").value;
                    ...
                    var loanamo = amount*count;
                    alert(loanamo+"===="+newamount);

        
                    if (loanamo<newamount) {
                        const Toast = Swal.mixin({
                                    toast: true,
                                    position: 'top-end',
                                    showConfirmButton: false,
                                ...
                                Toast.fire({
                                    type: 'warning',
                                    title: 'Wrong loan count or amount...!'
                                });
                    }else{
