...
<head>
    ...
    <title>Sanju enterprises - Property loan Create</title>
...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Property Loan Create</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Property Loan Create Sheet</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                                        ...
                                                        <div class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="selectSm" id="SelectLm"
                                                                    ...
                                                                    <option value="1">Property Loan</option>
                                                                    <option value="1">Vehicle Loan</option>
                                                                </select>
                                                            </div>
                                                            <div class="row form-group">
                                                                <label for="cc-payment" class="control-label mb-1">
                                                                ...
                                                                <div class="col-12 col-md-12">
                                                                    <select name="select" id="select_id2" class="form-control" onchange="HandleChqequ();">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col col-md-12">
                                                                    <div class="input-group">
                                                                        <select name="selectSm" id="SelectLm"
                                                                            class=" form-control">
                                                                            <option value="0">Please select Interest
                                                                            </option>
                                                                        ...
                                                                        <div class="input-group-btn"><button
                                                                                class="btn btn-info">Calculate</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="cc-payment"
                                                                    class="control-label mb-1">Payment Monthly
                                                                    Amount</label>
                                                                <input id="cc-pament" name="cc-payment" type="text"
                                                                    class="form-control" aria-required="true"
                                                            ...
                                                            <div>
                                                                <button onclick="vwPlanPropertyLoan()" type="submit"
    ...
    <script>
        function vwPlanPropertyLoan(){
            var $fileUpload = $('#propertyloandfiles');
        ...
        function HandleChqequ(){
                 var name = document.getElementById("select_id2").value;
